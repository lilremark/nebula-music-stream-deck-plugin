...
Releases are tagged from commits already merged to `main`. A stable tag such as `v1.1.2` must
match `package.json` `1.1.2` and manifest `1.1.2.0`. GitHub Actions runs the full validation suite,
